...
export const Layout: React.FC<Props> = ({ user, onLogout, children }) => {
  ...
  return (
    <div className="min-h-screen bg-brand-light flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:sticky top-0 left-0 h-screen w-80 bg-brand-blue text-white z-50 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
          }`}
      >
